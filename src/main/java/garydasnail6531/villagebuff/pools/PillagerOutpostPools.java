...
public class PillagerOutpostPools {
    public static void init(LootTable.Builder tableBuilder) {
        tableBuilder.pool(ImprovedLootPoolHelpers.weightedPool(1.0F, 3.0F)
                .with(ImprovedLootPoolHelpers.stacked(Items.ARROW, 8.0F, 20.0F).setWeight(18).build())
                .with(ImprovedLootPoolHelpers.stacked(Items.IRON_INGOT, 1.0F, 4.0F).setWeight(12).build())
                ...
                .with(ImprovedLootPoolHelpers.stacked(Items.EMERALD, 1.0F, 2.0F).setWeight(4).build())
                .build());
    }
}
